...
<div class="compra-form">
    ...
    <div class="row">
        ...
        <?= $form->field($modelCompra, 'numeroFactura')->textInput(['maxlength' => true, 'readonly'=>true]) ?>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
        <?= $form->field($modelCompra, 'importe')->textInput(['maxlength' => true, 'readonly'=>true]) ?>
        </div>
        <div class="col-sm-2 left">
        <?= $form->field($modelCompra, 'notaCredito')->textInput(['maxlength' => true, 'readonly'=>true]) ?>
        </div>
        <div class="col-sm-2">
        <?= $form->field($modelCompra, 'notaDebito')->textInput(['maxlength' => true, 'readonly'=>true]) ?>
        </div>
        <div class="col-sm-2"></div>
    </div>
    <div class="row">
        <div class="col-sm-2">
        <?= $form->field($modelCompra, 'proveedor_codigo')->textInput(['readonly'=>true])->label('Codigo') ?>
        </div>
        <div class="col-sm-6">
            <div class="form-group field-pedido-proveedor_codigo">
            <label class="control-label" for="pedido-codigo">Proveedor</label>
            <input type="text" name="proveedor" value="<?= strtoupper($modelCompra->proveedor['razonSocial'].' '.$modelCompra->proveedor['nombre'].' '.$modelCompra->proveedor['apellido'].' '.$modelCompra->proveedor['tipoDocu'].': '.$modelCompra->proveedor['documento'])?>" class="form-control" readonly="true">
            </div>
        </div>
        <div class="col-sm-3">
                    ...
                    <div class="panel-body">
                        <?php
                            ...
                            if (!$modelDetalle->isNewRecord) {
                                echo Html::activeHiddenInput($modelDetalle, "[{$index}]compra_id");
                            }
                        ?>
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-2">
                            <?= $form->field($modelDetalle->material, "[{$index}]cantidadExistencia")->textInput(['maxlength' => true,'readonly'=>true])->label('Stock') ?>
                            </div>
                            <div class="col-sm-2">
                            <?= $form->field($modelDetalle->material, "[{$index}]precioUnitario")->textInput(['maxlength' => true,'readonly'=>true]) ?>
