...
use app\models\DetallePedidobSearch;
...
/**
 * DetallePedidobController implements the CRUD actions for DetallePedido model.
 */
class DetallePedidobController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        $searchModel = new DetallePedidobSearch();
